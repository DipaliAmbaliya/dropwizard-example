...
import dw.example.application.config.Greeting;
...
public class HelloService {
	...
	private Response sayGreetings(String name, String lang)  throws Exception {
		...
		CustomResponse customResponse = new CustomResponse(new CustomResponseStatus(0,"OK",LocalDateTime.now()));
		customResponse.setGreetings(answer);
		return Response.ok()
