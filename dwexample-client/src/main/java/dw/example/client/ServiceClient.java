...
import dw.example.api.dtos.HelloRequest;
...
public class ServiceClient {
	...
	public CustomResponse sayGreetingsGet(String name, String lang) throws ServiceClientException{
	...
	//Async request
	public Future<CustomResponse> sayGreetingsGetAsync(String name, String lang) {
	...
	public Future<CustomResponse> sayGreetingsGetAsyncListenableFuture(String name, String lang) {
	...
	public CustomResponse sayGreetingsPost(HelloRequest request) throws ServiceClientException{
		Response response = target
				.request(MediaType.APPLICATION_JSON)
	...
	private static Function<Response, CustomResponse> processResponseFunction = new Function<Response, CustomResponse>(){

		@Override
		public CustomResponse apply(Response response) {
			return processResponse(response);
		}
	...
	private static CustomResponse processResponse(Response response) throws ServiceClientException{
		log.info("Processing response");
		try {
			if (response.getStatusInfo().equals(Response.Status.OK)){
				return response.readEntity(CustomResponse.class);
			} else {
